...
import classes from "./payDuesListTemplate.module.scss";
...
const PayDuesListTemplate = () => {
	...
	const columns = [
		{ field: "dues_list_id", headerName: "رقم الكشف", width: "100px" },
		{ field: "name", headerName: "الأسم", width: "450px" },
		...
		<>
					...
					<div className={classes["view"]}>
						...
						<div className={classes.body}>
							...
							<div className={classes.line3}>
								مقابل <span>{info.title}</span> حسب التفاصيل التالية:
							</div>
							<div className={classes.line4}>
								<TemplateTable columns={columns} rows={dues} />
								<TemplateTable
									columns={[
										{ field: "total", headerName: "الاجمالي", width: "550px" },
										{
											field: "value",
			...
			<table className={classes["print"]} ref={componentRef}>
				...
				<tbody className={classes.body}>
					...
					<TemplateTable
						columns={[
							{ field: "total", headerName: "الاجمالي", width: "500px" },
							{
								field: "value",
								headerName: info.amount.toLocaleString("US-en"),
								width: "110px",
...
export default PayDuesListTemplate;
